...
public class Employees {
    ...
    public Employees(int employee_id, String first_name, String last_name, String email, String phone_number,
            String hire_date, int job_id, double salary, int manager_id, int department_id) {
    ...
    public String toString() {
        return "Employees [employee_id=" + employee_id + ", first_name=" + first_name + ", last_name=" + last_name
                ...
                + ", getEmployee_id()=" + getEmployee_id() + ", getClass()=" + getClass() + ", getFirst_name()="
                + getFirst_name() + ", getLast_name()=" + getLast_name() + ", getEmail()=" + getEmail()
                + ", getPhone_number()=" + getPhone_number() + ", getHire_date()=" + getHire_date() + ", getJob_id()="
                + getJob_id() + ", getSalary()=" + getSalary() + ", getManager_id()=" + getManager_id()
                + ", getDepartment_id()=" + getDepartment_id() + ", hashCode()=" + hashCode() + ", toString()="
                + super.toString() + "]";
    }
