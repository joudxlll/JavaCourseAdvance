...
public class JobDAO {
    ...
    public void inserjob(Jobs d) throws SQLException, ClassNotFoundException {
        ...
        st.setDouble(4, d.getJob_MaxSalary());
    ...
    public void updatejob(Jobs d) throws SQLException, ClassNotFoundException {
        ...
        st.setDouble(3, d.getJob_MaxSalary());
        st.executeUpdate();
    }

    public void deletejob(int jobtId) throws SQLException, ClassNotFoundException {
        Class.forName("org.sqlite.JDBC");
        Connection conn = DriverManager.getConnection(URL);
